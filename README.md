...
## 项目速览
- **项目类型：** 对话式 AI / 教育科技 / 产品评测与作品集重建
- **核心场景：** 帮助录取后学生理解入学流程并完成关键任务
- **核心问题：** 用户并不只是缺少信息，而是不知道当前该做什么、下一步怎么做
...
在原研究工作中，我从产品评测与用户体验视角分析 Lilo；在本公开仓库中，我将相关方法重新组织为不包含内部数据的作品集框架。

我的工作重点包括：

- 识别录取后学生在入学流程中的核心障碍，明确产品要解决的真实用户问题；
- 构建覆盖 30+ 使用场景的结构化评测框架，观察系统能力边界与典型失败模式；
- 使用 Root Cause Analysis 从交互设计、信息理解和任务完成等维度归因问题；
- 梳理欢迎引导、任务清单和对话支持之间的关系，建立从信息获取到任务推进的用户路径理解；
- 结合界面与使用场景，分析产品在对话式支持、任务引导和信任建立上的体验特点；
- 从 AI 产品视角总结系统在意图理解、信息组织、边界判断和支持方式上的关键设计点；
- 形成结构化案例文档，并提出可用于后续产品迭代的优化建议。

公开作品集不展示原始对话、用户身份或内部评测数据，也不将重建示例描述为真实研究样本。

我希望通过这一部分展示的，不只是我对项目内容的理解，更是我将复杂产品拆解为用户问题、交互逻辑与优化机会的能力。
---
...
通过对这个项目的整理与分析，我形成了几个关键判断：

### 1. 用户真正缺少的，往往不是信息本身
很多学生并不是完全没有看到信息，而是不知道这些信息和自己当前阶段有什么关系，也不知道最优先的任务是什么。

### 2. 对话式系统的价值不只是“回答问题”
如果系统只能回答问题，但不能帮助用户明确下一步行动，它的实际支持价值会非常有限。更好的对话体验应该服务于任务推进，而不仅是信息解释。

### 3. 在高风险流程中，可信度比“像会聊天”更重要
在入学场景中，用户需要的是清晰、稳定、可靠的支持，而不是表面自然但不够准确的回复。系统的边界意识和信息表达质量，会直接影响用户信任。
...
在这个作品集版本中，我希望整体视觉表达能够与 Lilo 所服务的使用场景保持一致。由于用户处在录取后到正式入学前的关键过渡阶段，产品在视觉上不应制造额外压力，而应传递出 **清晰、友好、可信、低负担** 的支持感。

因此，我更倾向于使用相对简洁、柔和的视觉语言，避免过强的技术感或复杂的信息堆叠，让用户能够更自然地把注意力放在“当前要做什么”以及“下一步如何行动”上。

对于对话式系统来说，视觉并不是独立存在的装饰层，而是体验的一部分。清晰的界面层级、容易接近的风格和适度的亲和感，都有助于用户在高压力任务场景中更快理解信息，并建立对系统的基本信任。
---
